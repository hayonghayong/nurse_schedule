<template>
    <v-container fluid class="editPatientCotainer pb-12">
        <v-card-text v-if="isActive.detailWrap" class="text-center detailCard">
            <v-row>
                <h1 class="headline text-center">患者詳細情報</h1>
                <v-col cols="12 mt-4">
                    <div
                        class="d-flex justify-space-between px-4 detailTextWarp"
                    >
                        <p class="patientItem">部屋番号</p>
                        <p class="patientNode">
                            {{ editPatientData.room }}
                        </p>
                    </div>
                    <v-divider></v-divider>
                </v-col>
